...
date: 2023-11-02
language: en
image: /assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/chipception.png

title: Writing a CHIP-8 interpreter in CHIP-8
excerpt: >
  I had been thinking about writing a CHIP-8 interpreter in CHIP-8 for almost
  two years or so. It's just such an insane idea that I couldn't help but find
  myself attracted to it. For Octojam 10, I made it happen!

titel: Een CHIP-8 interpreter, geschreven in CHIP-8
samenvatting: >
  Ik overwoog al ongeveer twee jaar om een CHIP-8 interpreter in CHIP-8 te
  schrijven. Het is zo'n belachelijk idee dat ik me er onweerstaanbaar toe
  aangetrokken voelde. Dus werd het tijd om het te maken voor Octojam 10!
---

![Chipception OS running]({{
"assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/chipception.png"
| relative_url }})

This is the development log of [Chipception
OS](https://github.com/Timendus/chipception), a CHIP-8 and SUPER-CHIP
interpreter written in XO-CHIP. My submission to Octojam 10. Because CHIP-8
interpreters have been written in every programming language and the platform
also deserves one written in CHIP-8 itself! 😄
...
![A mocked-up "CHIP-8 OS desktop running two CHIP-8 programs in parallel"]({{
"assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/concept1-large.png"
| relative_url }})
...
![Passing the quirks test]({{
"assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/passing-quirks.png"
| relative_url }})
...
![Running multiple interpreters in split-screen]({{
"assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/split-screen.gif"
| relative_url }})
...
![Running multiple interpreters in windows with borders]({{
"assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/bordered-windows.gif"
| relative_url }})
...
![Managing windows in Chipception]({{
"assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/window-management.gif"
| relative_url }})
...
<div class="image-group">
  <img src="{{'assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/background-layer1.png' | relative_url }}" alt="Background layer one"/>
  <img src="{{'assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/background-layer2.png' | relative_url }}" alt="Background layer two"/>
</div>
...
"assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/now-with-background.png"
| relative_url }})
...
![One alternative]({{
"assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/different-shadows-1.png"
| relative_url }})

![Another alternative]({{
"assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/different-shadows-2.png"
| relative_url }})
...
![The launcher ROM in action]({{
"assets/images/articles/2023-10-02-writing-a-chip-8-interpreter-in-chip-8/launcher.gif"
| relative_url }})
...
_This article was published earlier as a development log on the [Github
repository for Chipception](https://github.com/Timendus/chipception)._
